...
export const legacyPages: readonly LegacyPage[] = [
  ...
  { file: 'dashboard-legacy.html', cleanPath: '/dashboard-legacy', title: '管理看板（旧版回退）', risk: 'medium' },
  { file: 'employees.html', cleanPath: '/employees', title: '员工管理', risk: 'medium' },
  { file: "employees-legacy.html", cleanPath: '/employees-legacy', title: '员工管理（旧版回退）', risk: 'medium' },
